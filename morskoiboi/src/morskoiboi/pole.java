...
public class pole extends JPanel{
	...
	public pole() {
		...
		myGame.start();
		try {
			fon = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\Загорский\\Картинки морской  бой\\fon.png"));
			paluba = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\\\Загорский\\Картинки морской  бой\\paluba.png"));
			ranen = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\Загорский\\Картинки морской  бой\\ranen.png"));
			ubit = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\Загорский\\Картинки морской  бой\\ubit.png"));
			end1 = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\Загорский\\Картинки морской  бой\\end1.png"));
			end2 = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\Загорский\\Картинки морской  бой\\end2.png"));
			bomba = ImageIO.read(new File("X:\\ГРУППЫ\\ПРОГРАММИСТЫ\\ИП22\\Загорский\\Картинки морской  бой\\bomba.png"));
		}
		catch (Exception ex) {}
